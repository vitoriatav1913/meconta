...
const onChange = evt => {
  ...
  setForm(old => ({
    ...
    return (
        <div className='pt-12 px-8 py-12 max-w-md mx-auto sm:max-w-xl ' >
          ...
          { !sucess &&  <div className='flex flex-col justify-center' >
              ...
              <label className='font-bold text-center' >Nota para o Estabelecimento:</label>
